  ...
  <section class="mb-5 coverImage">
    @include('frontendtemplate.navbarn')
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6  pt-5 mt-5  d-block ">
                ...
                <button  class="btn btn-primary btnarena">Open Opportunities</button>                <img class="img-fluid p-2" src="{{asset('asset/images/Icon ionic-ios-play-circle.png')}}">
              </div>
        </div>
        </div>
      </section>
